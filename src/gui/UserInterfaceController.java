...
@FXML
         public void Hom(ActionEvent event) throws IOException {

        FXMLLoader loader = new FXMLLoader();
        am.getScene().getWindow().hide();
        am1.getScene().getWindow().hide();
